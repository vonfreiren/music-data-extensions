...
# Convert to desired format
    ...
    if not df_concerts.empty:
        ...
        df_concerts.to_html(path_jekyll, index=False, classes='table-responsive table-bordered', table_id='table_concerts', border=0, escape=False, justify='center', col_space=100, na_rep='N/A')
